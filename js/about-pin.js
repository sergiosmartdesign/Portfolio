 ...
 *   smoothScrollTo is injected by the caller (script.js) to avoid a circular
 *   import — the function already carries the correct default duration via its
 *   own closure over TIMING.NAV_SCROLL_DURATION.
 *
 * Modes:
...
export function initAboutPin(smoothScrollTo) {
